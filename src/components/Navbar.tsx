...
//         {/* Updated container: justify-center to center-align the nav items */}
//         <div className="hidden md:flex items-center justify-center gap-6 lg:gap-4 xl:gap-6 w-full">
//           {navItems.map((item, index) => (
//             <div
//               key={index}
//               className={`relative group px-4 py-3 transition-all text-lg lg:text-base xl:text-lg ${
//                 activeItem === item.label ? "text-white" : "text-gray-500"
//               }`}
//               style={{
//                 zIndex: activeItem === item.label ? 1 : "auto",
//               }}
//             >
//               <p
...
//       <section className="hidden md:flex items-center gap-6 lg:gap-4">
//         <ShinyButton
