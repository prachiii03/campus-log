...
//           <div className="relative mx-16 md:mx-20 flex items-center justify-between">
...
//   // Track dark mode change using class from ThemeToggler
...
//                 <Link
//                   href="/signup"
//                   className="ease-in-up shadow-btn hover:shadow-btn-hover hidden rounded-sm bg-primary px-8 py-3 text-base font-medium text-black transition duration-300 hover:bg-opacity-90 md:block md:px-9 lg:px-6 xl:px-9 dark:text-white"
//                 >
//                   Sign Up
//                 </Link>
//                 <div>
//                   <ThemeToggler onThemeChange={handleThemeChange} />
//                 </div>
//               </div>
//             </div>
//           </div>
...
import Image from "next/image";
import Link from "next/link";
import { usePathname } from "next/navigation"; // Correct usage
import { useEffect, useState } from "react";
import ThemeToggler from "./ThemeToggler"; // Ensure the prop is properly passed and handled inside this component
import menuData from "./menuData";
                          ...
                          {menuItem.submenu && (
                            ...
                            >
                              {menuItem.submenu.map((submenuItem, subIndex) => (
                                <Link
                                  href={submenuItem.path || "/"} // Ensure there's a fallback path
                                  key={subIndex}
                                  className="block rounded py-2.5 text-sm text-dark hover:text-primary dark:text-white/70 dark:hover:text-white lg:px-3"
                                >
                                  {submenuItem.title}
