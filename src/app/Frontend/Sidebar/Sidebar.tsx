...
export function SidebarDemo() {
  ...
  return (
    <div
      className={cn(
        "rounded-md flex flex-col md:flex-row bg-gray-100 dark:bg-neutral-800 w-auto flex-1 border border-neutral-200 dark:border-neutral-700 overflow-hidden h-auto "
